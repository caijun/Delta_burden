...
files <- list.files("output/single/AON", full.names = T)
file <- files[4]
...
outfile <- glue("figs/single/AON/epi_curve_R0-{R0}_ve2-{ve2}_Tonset-{Tonset}_strategy-{strategy}_nsim-{nsim}.tif")
...
outfile <- glue("figs/single/AON/cumI_prop_R0-{R0}_ve2-{ve2}_Tonset-{Tonset}_strategy-{strategy}_nsim-{nsim}.tif")
tiff(outfile, width = 12, height = 10, unit = "in", res = 300, compression = "lzw")
print(p2)
dev.off()
...
outfile <- glue("figs/single/AON/2dose_coverage_R0-{R0}_ve2-{ve2}_Tonset-{Tonset}_strategy-{strategy}_nsim-{nsim}.tif")
tiff(outfile, width = 12, height = 10, unit = "in", res = 300, compression = "lzw")
print(p3)
dev.off()
